...
public class SpreadManager {
    ...
    //private StringManager stringMng;
    private Calculator calculator;

    public SpreadManager() {
        spreadFabric = new SpreadFabric(this);
        //this.stringMng = new StringManager();
        this.calculator = new Calculator(this);
    }

    //TALK 
    public SpreadManager(StringManager sm) {
        spreadFabric = new SpreadFabric(this);
        //this.stringMng = sm;
        this.calculator = new Calculator(this);
    }
    ...
    public boolean spreadsheetFromFile(Map<Coordinate, String> map) {
        ...
        for (Coordinate coor : map.keySet()) {
            ...
            if (cell.getStatus() == Cell.CellState.FORMULA) {
    ...
    public void updateCell(Cell cell) throws LogicalLoopException, NaNException, TextValueException {
    ...
    public boolean coordinateInside(Coordinate c) {
        return spreadsheet.isCoorInside(c);
    }

    public void checkLogicalLoop(Cell cell, List<Coordinate> listCoor) throws LogicalLoopException {
        List<Cell> lCells = spreadsheet.getCells(listCoor);
        for (Cell c : lCells) {
