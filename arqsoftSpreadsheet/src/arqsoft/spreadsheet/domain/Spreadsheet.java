...
public class Spreadsheet {
    ...
    public List<Cell> getCells(List<Coordinate> list_coord) {
        List<Cell> list_cells = new LinkedList<>();
        for (Coordinate coor : list_coord) {
    ...
    public boolean isCoorInside(Coordinate c) {
        if (c.getRow() < maxRow && c.getCol() < maxCol) {
            return true;
        }
        return false;
    }
