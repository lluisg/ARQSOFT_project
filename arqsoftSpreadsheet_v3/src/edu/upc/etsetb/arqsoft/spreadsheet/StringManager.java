...
import edu.upc.etsetb.arqsoft.spreadsheet.domain.FormulaComponentFabric;
...
import edu.upc.etsetb.arqsoft.spreadsheet.domain.OperatorType;
import java.util.*;
...
public class StringManager {
    ...
    public static List<Token> parseString(String string) throws CancelException, ParserException{
    ...
    public static List<FormulaComponent> infix2postfix(List<Token> tokens){
        ...
        for (int i=0 ; i<tokens.size() ; i++){
            ...
            switch (tok.getType()){
                ...
                case OPERATOR:   
                    OperatorType ot = fcFabric.string2operatorType(content);
