...
import edu.upc.etsetb.arqsoft.spreadsheet.FileManager.FileSource;
...
public class Manager {
    ...
    public void Init() throws ParserException, IOException{
        ...
        while(!closeProgram){
            ...
            switch(instruction){
                ...
                case 5:
                    Map<Coordinate, String> cont = spreadMng.getContentSpreadsheet();
                    int[] ss = spreadMng.getSizeSpread();
                    UI.displaySpreadsheet(cont, ss);
                    break;
    ...
    private String getSaveFilePath() throws CancelException, IOException{
        ...
        while(!name){
            ...
            if(!file.endsWith("."+FileManager.AcceptedFileType.C2V.getFileExtension())){
                file = file + ".c2v";
            }
            try{
    ...
    private boolean warnInfoLoss() {
        return UI.warnInfoLoss();
    }
