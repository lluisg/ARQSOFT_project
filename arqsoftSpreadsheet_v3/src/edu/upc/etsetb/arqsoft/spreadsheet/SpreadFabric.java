...
import edu.upc.etsetb.arqsoft.spreadsheet.domain.Content;
import edu.upc.etsetb.arqsoft.spreadsheet.domain.Coordinate;
import edu.upc.etsetb.arqsoft.spreadsheet.domain.Formula;
import edu.upc.etsetb.arqsoft.spreadsheet.domain.Numerical;
import edu.upc.etsetb.arqsoft.spreadsheet.domain.Spreadsheet;
import edu.upc.etsetb.arqsoft.spreadsheet.domain.Text;
import java.util.*;
